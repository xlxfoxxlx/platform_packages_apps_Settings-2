...
public class BlurSettings extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mExpand = (SwitchPreference) prefSet.findPreference(
        ...
        mHeaderSettPerc.setValue(Settings.System.getInt(resolver,
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mScale) {
            ...
            Settings.System.putInt(resolver,
                    Settings.System.TRANSLUCENT_QUICK_SETTINGS_PRECENTAGE_PREFERENCE_KEY, value);
            return true;
            ...
            int value = ((Integer)newValue).intValue();
            Settings.System.putInt(resolver,
                    Settings.System.TRANSLUCENT_NOTIFICATIONS_PRECENTAGE_PREFERENCE_KEY, value);
            return true;
        }
        return false;
    }
