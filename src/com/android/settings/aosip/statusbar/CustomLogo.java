...
public class CustomLogo extends SettingsPreferenceFragment implements OnPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String hexColor = String.format("#%08x", (0xffffffff & intColor));
            ...
            int AosipLogoStyle = Settings.System.getIntForUser(getContentResolver(),
                    Settings.System.CUSTOM_LOGO_STYLE, 0,
                    UserHandle.USER_CURRENT);
            mCustomLogoStyle.setValue(String.valueOf(AosipLogoStyle));
        ...
        if (preference == mCustomLogoColor) {
            ...
            return true;
                ...
                Settings.System.putIntForUser(
                       getContentResolver(), 
		Settings.System.CUSTOM_LOGO_STYLE, AosipLogoStyle,
                        UserHandle.USER_CURRENT);
