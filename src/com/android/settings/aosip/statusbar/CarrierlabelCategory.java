...
public class CarrierlabelCategory extends SettingsPreferenceFragment implements
    ...
    private CustomEditTextPreference mCustomLabel;
    ...
    public void refreshSettings() {
        ...
        if (!isHidden) {
            ...
            if (useCustom) {
                mCustomLabel = (CustomEditTextPreference) findPreference(PREF_CARRIER_LABEL_CUSTOM_LABEL);
